    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="section__title text-center pb--50">
                ...
                <p>Những tựa sách được các bạn trẻ đón đọc trong thời gian vừa qua.</p>
            </div>
        </div>
    </div>
</div>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="product product__style--3">
            <div class="product__thumb">
                <a class="first__img" href="single-product.html"><img src="public/<?php echo $row['img'] ?>" alt="product image"></a>
            </div>
