                        ...
                        <div class="content-shopby">
                            <div class="price_filter s-filter clear">
                                <form id="filter_price">
                                    <label style="width:70px" for="">Tác phẩm</label>
                                    <input style="border-radius:5px;border:none;border:1px solid #999;padding:5px" onkeyup="submit_filter()" name="title" type="text">
                                    <label style="width:70px" for="">Tác giả</label>
                                    <input style="border-radius:5px;border:none;border:1px solid #999;padding:5px" onkeyup="submit_filter()" name="author" type="text">
